...
class YOLOv3Module(pl.LightningModule):
    ...
    def _common_step(
        self, batch: list, batch_idx: int, mode: str
        ...
        results = (
            reduce_boxes(preds, min_max_size=(2, self.img_size))
            if mode != "train"
            else preds
        )
        # Metrics
    ...
    def test_step(self, batch, batch_idx: int) -> Dict[str, float]:
        ...
        return {
            "test_loss": loss,
            "test_mAP": mAP_dict["map"].item(),
            "test_mAP50": mAP_dict["map_50"].item(),
        }
    ...
    def validation_step(self, batch, batch_idx: int) -> Dict[str, float]:
        ...
        return {
            ...
            "val_mAP50": mAP_dict["map_50"].item(),
        }
